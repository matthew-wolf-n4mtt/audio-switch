...
;  
; This file is part of the Audio-Switch-MK3.
...
; along with the Audio-Switch-MK3.
...
;Command mode
;
;i- Enter Command mode (e to exit command mode)
;
;l,r,a,b Enter select output (e to exit output level)
...
I2CMultAddr equ B'11100000'

I2CMultNoBus equ B'00000000'
I2CMultBus0 equ B'11111000'
...
I2CTopSwitchAddr equ B'01101010'
I2CBottomSwitchAddr equ B'01101110'

Switch_Top     equ B'00000001'  ;Frist Mux commands
Switch_Bottom  equ B'00000010'

Switch_1    equ B'00000001'
Switch_2    equ B'00000010'
...
Led75		equ		H'80'			;Back Light levels
Led50		equ		H'40'
Led25		equ		H'20'
Led10		equ		H'10'
...
L_Mux
        ...
        pagesel i2c_SendMultBus0
        call    i2c_SendMultBus0
        ...
        pagesel  i2c_TopFirstSwitchAddr
        call    i2c_TopFirstSwitchAddr

        pagesel i2c_LFirstSwitchData
        call    i2c_LFirstSwitchData
        ...
        pagesel  i2c_SendMultBus1
        call    i2c_SendMultBus1
        ...
        pagesel i2c_LSecondSwitchAddr
        call    i2c_LSecondSwitchAddr

        pagesel i2c_LSecondSwitchData
        call    i2c_LSecondSwitchData

        pagesel i2c_Stop
        call	i2c_Stop

        ;; set i2c mult to no bus
		return
...
R_Mux
        ...
        pagesel  i2c_BottomFirstSwitchAddr
        call    i2c_BottomFirstSwitchAddr
  
        pagesel i2c_RFirstSwitchData ;added
        call    i2c_RFirstSwitchData

        pagesel i2c_Stop ;added
        call    i2c_Stop
        ...
        pagesel  i2c_SendMultBus2
        call    i2c_SendMultBus2
        ...
        pagesel i2c_RSecondSwitchAddr
        call    i2c_RSecondSwitchAddr

        pagesel i2c_RSecondSwitchData ; added
        call    i2c_RSecondSwitchData
...
A_Mux
        ...
        pagesel i2c_SendMultBus3
        call    i2c_SendMultBus3
        ...
        pagesel i2c_AFirstSwitchData
        call    i2c_AFirstSwitchData
        ...
        pagesel  i2c_SendMultBus4
        call    i2c_SendMultBus4
        ...
        pagesel i2c_ASecondSwitchAddr
        call    i2c_ASecondSwitchAddr

        pagesel i2c_ASecondSwitchData
        call    i2c_ASecondSwitchData
...
B_Mux
        ...
        pagesel i2c_BFirstSwitchData
        call    i2c_BFirstSwitchData
        ...
        pagesel  i2c_SendMultBus5
        call    i2c_SendMultBus5
        ...
        pagesel i2c_BSecondSwitchAddr
        call    i2c_BSecondSwitchAddr

        pagesel i2c_BSecondSwitchData
        call    i2c_BSecondSwitchData
...
i2c_TopFirstSwitchAddr
		banksel		SSPBUF
        movlw       I2CTopSwitchAddr
		movwf		SSPBUF				; write is i2c buss
        btfsc		SSPSTAT,R_NOT_W		;Wait r_w clear at 9th (ACk) clock
		goto		$-1
...
i2c_BottomFirstSwitchAddr
		banksel		SSPBUF
        movlw       I2CBottomSwitchAddr
		movwf		SSPBUF				; write is i2c buss
        btfsc		SSPSTAT,R_NOT_W		;Wait r_w clear at 9th (ACk) clock
		goto		$-1
...
;__________Program Memory Page1
        org         0x0800
...
i2c_SendMultBus5
       ...
       return
;Left
i2c_LFirstSwitchData
  		movlb		H'00'
		movf		PortLCount,W
        pagesel     First_Switch_Command
        call        First_Switch_Command ; DATA Byte returned to W
        ;clrf        PCLATH
...
i2c_LSecondSwitchAddr
 		movlb		H'00'
		movf		PortLCount,W
        pagesel     Second_Switch_Addr
        call        Second_Switch_Addr ; DATA Byte returned to W
        ;clrf        PCLATH
...
i2c_LSecondSwitchData
 		banksel     PortLCount
        movlb		H'00'
		movf		PortLCount,W
        pagesel     Switch_Port_Num
        call        Switch_Port_Num ; DATA Byte returned to W
        ;clrf        PCLATH
...
First_Switch_Command   ;Get first mux command
       movwf        MuxSource
...
Switch_Port_Num						; Get then Mux connand
		movwf		MuxSource

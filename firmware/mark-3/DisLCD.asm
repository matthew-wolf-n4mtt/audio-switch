...
;-------------------------------------------
SerDisInNum 	movwf		PortIdx
				clrf		CharIdx

SerDisInNumS	bcf			STATUS,Z		; Reset Status reg
				movf		PortIdx,W
				xorlw		H'00'
				btfsc		STATUS,Z		; Was it Zero?
				goto		SerInput1Num
...
SerInput1Num	clrf		CharIdx
				bcf			STATUS,Z

SerInput1NumT	movf		CharIdx,W		
				call		Input1NumTs		
				xorlw		H'00'			; Test to see if char is Zero
				btfsc		STATUS,Z		; Was it Zero?
				return					
